"""
Django settings for QingningWork project.
...
SECRET_KEY = '+_&^c((l!j04-j@y4c05m^r2q-xm%!0njosk2gwpt0o_0d05d2'
...
ROOT_URLCONF = 'QingningWork.urls'
...
WSGI_APPLICATION = 'QingningWork.wsgi.application'
